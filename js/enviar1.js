...
function retornarDatos()
{
  var cad='';
	...
	var obser8=document.getElementById('obser8').value;
	var obser9=document.getElementById('obser9').value;
	var obser10=document.getElementById('obser10').value;
...
if(document.getElementById('radio22').checked){
	...
	if(document.getElementById('radio23').checked){
		var res8=document.getElementById('radio23').value;
cad='res1='+encodeURIComponent(res1)+'&obser1='+encodeURIComponent(obser1)+'&res2='+encodeURIComponent(res2)+'&obser2='+encodeURIComponent(obser2)+'&res3='+encodeURIComponent(res3)+'&obser3='+encodeURIComponent(obser3)+'&res4='+encodeURIComponent(res4)+'&obser4='+encodeURIComponent(obser4)+'&res5='+encodeURIComponent(res5)+'&obser5='+encodeURIComponent(obser5)+'&res6='+encodeURIComponent(res6)+'&obser6='+encodeURIComponent(obser6)+'&res7='+encodeURIComponent(res7)+'&obser7='+encodeURIComponent(obser7)+'&res8='+encodeURIComponent(res8)+'&obser8='+encodeURIComponent(obser8);
		}
		else 
		if(document.getElementById('radio24').checked){
			var res8=document.getElementById('radio24').value;
cad='res1='+encodeURIComponent(res1)+'&obser1='+encodeURIComponent(obser1)+'&res2='+encodeURIComponent(res2)+'&obser2='+encodeURIComponent(obser2)+'&res3='+encodeURIComponent(res3)+'&obser3='+encodeURIComponent(obser3)+'&res4='+encodeURIComponent(res4)+'&obser4='+encodeURIComponent(obser4)+'&res5='+encodeURIComponent(res5)+'&obser5='+encodeURIComponent(obser5)+'&res6='+encodeURIComponent(res6)+'&obser6='+encodeURIComponent(obser6)+'&res7='+encodeURIComponent(res7)+'&obser7='+encodeURIComponent(obser7)+'&res8='+encodeURIComponent(res8)+'&obser8='+encodeURIComponent(obser8);
			}
			else 
			if(document.getElementById('radio25').checked){
		 var res8=document.getElementById('radio25').value;
cad='res1='+encodeURIComponent(res1)+'&obser1='+encodeURIComponent(obser1)+'&res2='+encodeURIComponent(res2)+'&obser2='+encodeURIComponent(obser2)+'&res3='+encodeURIComponent(res3)+'&obser3='+encodeURIComponent(obser3)+'&res4='+encodeURIComponent(res4)+'&obser4='+encodeURIComponent(obser4)+'&res5='+encodeURIComponent(res5)+'&obser5='+encodeURIComponent(obser5)+'&res6='+encodeURIComponent(res6)+'&obser6='+encodeURIComponent(obser6)+'&res7='+encodeURIComponent(res7)+'&obser7='+encodeURIComponent(obser7)+'&res8='+encodeURIComponent(res8)+'&obser8='+encodeURIComponent(obser8);
	}
if (document.getElementById('radio26').checked){
var res9=document.getElementById('radio26').value;
cad='res1='+encodeURIComponent(res1)+'&obser1='+encodeURIComponent(obser1)+'&res2='+encodeURIComponent(res2)+'&obser2='+encodeURIComponent(obser2)+'&res3='+encodeURIComponent(res3)+'&obser3='+encodeURIComponent(obser3)+'&res4='+encodeURIComponent(res4)+'&obser4='+encodeURIComponent(obser4)+'&res5='+encodeURIComponent(res5)+'&obser5='+encodeURIComponent(obser5)+'&res6='+encodeURIComponent(res6)+'&obser6='+encodeURIComponent(obser6)+'&res7='+encodeURIComponent(res7)+'&obser7='+encodeURIComponent(obser7)+'&res8='+encodeURIComponent(res8)+'&obser8='+encodeURIComponent(obser8)+'&res9='+encodeURIComponent(res9)+'&obser9='+encodeURIComponent(obser9);
	}
	else 
	if(document.getElementById('radio27').checked){
	var res9=document.getElementById('radio27').value;
cad='res1='+encodeURIComponent(res1)+'&obser1='+encodeURIComponent(obser1)+'&res2='+encodeURIComponent(res2)+'&obser2='+encodeURIComponent(obser2)+'&res3='+encodeURIComponent(res3)+'&obser3='+encodeURIComponent(obser3)+'&res4='+encodeURIComponent(res4)+'&obser4='+encodeURIComponent(obser4)+'&res5='+encodeURIComponent(res5)+'&obser5='+encodeURIComponent(obser5)+'&res6='+encodeURIComponent(res6)+'&obser6='+encodeURIComponent(obser6)+'&res7='+encodeURIComponent(res7)+'&obser7='+encodeURIComponent(obser7)+'&res8='+encodeURIComponent(res8)+'&obser8='+encodeURIComponent(obser8)+'&res9='+encodeURIComponent(res9)+'&obser9='+encodeURIComponent(obser9);
		}
		else 
		if(document.getElementById('radio28').checked){
	 var res9=document.getElementById('radio28').value;
cad='res1='+encodeURIComponent(res1)+'&obser1='+encodeURIComponent(obser1)+'&res2='+encodeURIComponent(res2)+'&obser2='+encodeURIComponent(obser2)+'&res3='+encodeURIComponent(res3)+'&obser3='+encodeURIComponent(obser3)+'&res4='+encodeURIComponent(res4)+'&obser4='+encodeURIComponent(obser4)+'&res5='+encodeURIComponent(res5)+'&obser5='+encodeURIComponent(obser5)+'&res6='+encodeURIComponent(res6)+'&obser6='+encodeURIComponent(obser6)+'&res7='+encodeURIComponent(res7)+'&obser7='+encodeURIComponent(obser7)+'&res8='+encodeURIComponent(res8)+'&obser8='+encodeURIComponent(obser8)+'&res9='+encodeURIComponent(res9)+'&obser9='+encodeURIComponent(obser9);
     	}
		if(document.getElementById('radio29').checked){
		var res10=document.getElementById('radio29').value;	
cad='res1='+encodeURIComponent(res1)+'&obser1='+encodeURIComponent(obser1)+'&res2='+encodeURIComponent(res2)+'&obser2='+encodeURIComponent(obser2)+'&res3='+encodeURIComponent(res3)+'&obser3='+encodeURIComponent(obser3)+'&res4='+encodeURIComponent(res4)+'&obser4='+encodeURIComponent(obser4)+'&res5='+encodeURIComponent(res5)+'&obser5='+encodeURIComponent(obser5)+'&res6='+encodeURIComponent(res6)+'&obser6='+encodeURIComponent(obser6)+'&res7='+encodeURIComponent(res7)+'&obser7='+encodeURIComponent(obser7)+'&res8='+encodeURIComponent(res8)+'&obser8='+encodeURIComponent(obser8)+'&res9='+encodeURIComponent(res9)+'&obser9='+encodeURIComponent(obser9)+'&res10='+encodeURIComponent(res10)+
'&obser10='+encodeURIComponent(obser10);	
			}
	else 
	if(document.getElementById('radio30').checked){
var res10=document.getElementById('radio30').value;
cad='res1='+encodeURIComponent(res1)+'&obser1='+encodeURIComponent(obser1)+'&res2='+encodeURIComponent(res2)+'&obser2='+encodeURIComponent(obser2)+'&res3='+encodeURIComponent(res3)+'&obser3='+encodeURIComponent(obser3)+'&res4='+encodeURIComponent(res4)+'&obser4='+encodeURIComponent(obser4)+'&res5='+encodeURIComponent(res5)+'&obser5='+encodeURIComponent(obser5)+'&res6='+encodeURIComponent(res6)+'&obser6='+encodeURIComponent(obser6)+'&res7='+encodeURIComponent(res7)+'&obser7='+encodeURIComponent(obser7)+'&res8='+encodeURIComponent(res8)+'&obser8='+encodeURIComponent(obser8)+'&res9='+encodeURIComponent(res9)+'&obser9='+encodeURIComponent(obser9)+'&res10='+encodeURIComponent(res10)+'&obser10='+encodeURIComponent(obser10);
	}
	else
if(document.getElementById('radio31').checked){
var res10=document.getElementById('radio31').value;
cad='res1='+encodeURIComponent(res1)+'&obser1='+encodeURIComponent(obser1)+'&res2='+encodeURIComponent(res2)+'&obser2='+encodeURIComponent(obser2)+'&res3='+encodeURIComponent(res3)+'&obser3='+encodeURIComponent(obser3)+'&res4='+encodeURIComponent(res4)+'&obser4='+encodeURIComponent(obser4)+'&res5='+encodeURIComponent(res5)+'&obser5='+encodeURIComponent(obser5)+'&res6='+encodeURIComponent(res6)+'&obser6='+encodeURIComponent(obser6)+'&res7='+encodeURIComponent(res7)+'&obser7='+encodeURIComponent(obser7)+'&res8='+encodeURIComponent(res8)+'&obser8='+encodeURIComponent(obser8)+'&res9='+encodeURIComponent(res9)+'&obser9='+encodeURIComponent(obser9)+'&res10='+encodeURIComponent(res10)+'&obser10='+encodeURIComponent(obser10);
		}
			else{
...
function enviarFormulario() 
{
  ...
  conexion1.open('POST','insertar1.php', true);
...
function procesarEventos()
{
  ...
  if(conexion1.readyState == 4)
  {
    if (conexion1.status==200)
      resultados1.innerHTML = parent.location.href="pagina3.php";
    else
