...
<title>Valoración claridad administrativa</title>
<link href="css/enestilo.css" rel="stylesheet" type="text/css" />
<script language="javascript" src="js/enviar2.js"></script>
</head>
<body>
<div id="header">
</div>
<div id="contenedor">
<form name="form" id="form" method="post" onSubmit="return validacion(this)" action="insertar2.php">
<p><i><h2>Valoración claridad administrativa
</h2></i>
<p><i>1).Tiene claridad frente a la linea de mando?</i></p>
...
<p><i>2).Tiene clara  la remuneracion por la labor cumplida?</i></p>
...
<p><i>3).Conoce y tiene claras las politicas de trabajo en su cargo?</i></p>
<p>
...
<p><i>4).Conoce y tiene claras sus funciones y responsabilidades?</i></p>
<p>
...
<p><i>5).Tiene la suficiente autonomía en su trabajo?</i></p>
<p>
...
<br />
<p><i>6).Tiene la suficiente capacidad de iniciativa en su trabajo?</i></p>
...
<br />
<p><i>7).Sus ideas son escuchadas por su jefe y/o superiores?</i></p>
<input type="radio" name="res7"  id="radio20" value="si" checked="checked"/>Si
<br />
<input type="radio" name="res7" id="radio21" value="si/no depende"/>Si/no depende
<br>
<input type="radio" name="res7" id="radio22" value="no"/>No
<br />
<p><i>Observaciones y/o sugerencias</i></p>
<br />
