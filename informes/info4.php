...
<script language="javascript" src="ajax/informe4.js"></script>
</head>
<body>
<center><p><h3>Valoración de orgullo y sentido de pertenencia a la Empresa</h3></p></center>
<center><h4>Tiempo que espera estar en la empresa</h4></center>
<center>
<p><h4>Seleccione sobre que usuario desea obtener el informe </h4></p></center>
<div>
<center>
<form name="form1" id="form1" method="post" onSubmit="return validacion(this)" action="informe4.php">
<select name="opc">
