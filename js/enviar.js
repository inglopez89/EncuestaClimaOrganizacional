...
cad='res1='+encodeURIComponent(res1)+'&obser1='+encodeURIComponent(obser1);
	...
	if(document.getElementById('radio8').checked){
		...
		cad='res1='+encodeURIComponent(res1)+'&obser1='+encodeURIComponent(obser1)+'&res2='+encodeURIComponent(res2)+'&obser2='+encodeURIComponent(obser2)+'&res3='+encodeURIComponent(res3)+'&obser3='+encodeURIComponent(obser3);
					...
					cad='res1='+encodeURIComponent(res1)+'&obser1='+encodeURIComponent(obser1)+'&res2='+encodeURIComponent(res2)+'&obser2='+encodeURIComponent(obser2)+'&res3='+encodeURIComponent(res3)+'&obser3='+encodeURIComponent(obser3)+'&res4='+encodeURIComponent(res4);
	...
	if(document.getElementById('radio11').checked){
		...
		var res5=document.getElementById('radio14').value;
					cad='res1='+encodeURIComponent(res1)+'&obser1='+encodeURIComponent(obser1)+'&res2='+encodeURIComponent(res2)+'&obser2='+encodeURIComponent(obser2)+'&res3='+encodeURIComponent(res3)+'&obser3='+encodeURIComponent(obser3)+'&res4='+encodeURIComponent(res4)+'&res5='+encodeURIComponent(res5)+'&obser5='+encodeURIComponent(obser5);
...
function procesarEventos()
{
  ...
  if(conexion1.readyState == 4)
  {
    if (conexion1.status==200)
      resultados1.innerHTML = parent.location.href="pagina2.php";
    else
